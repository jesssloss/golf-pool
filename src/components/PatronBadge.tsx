...
export default function PatronBadge({ poolName, year = '2026', playerName }: Props) {
  return (
    <div className="mx-auto max-w-sm rounded-lg bg-augusta border-2 border-masters-gold p-8 text-center">
      ...
      {playerName && (
        <div className="mt-4 pt-4 border-t border-masters-gold/40 milestone-fade">
